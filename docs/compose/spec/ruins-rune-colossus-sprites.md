...
Form1 沉默石像 → 觉醒**高阶石质贤者**（非人类法师/骑士/机甲）。

| 项 | 要求 |
|----|------|
| 体型 | 比 Form1 修长高大；头小肩宽躯干长腿长 |
| **四臂** | 恰四条石臂：上一对肩侧（一抬一展）、下一对腰侧（一近腰一垂）；关节苔藓符文；禁双臂/五臂 |
| 头面 | 石刻面甲无皮肤；符文裂口眼；额符颊裂；继承石纹 |
| **胸口符核** | 继承 Form1 更亮更复杂（环/六边核）；能量入四臂 |
| 石甲长袍 | 上甲下石板苔藓符文袍；禁现代法师袍 |
| **悬浮棋盘** | 背后 3/4 浮空符文棋盘/魔法阵；**不挡身体**；略大于上半身 |
...
1. **法袍可读**：外层长袍+高领/披肩领；小臂被袖筒裹半；长下摆石片；一眼是高阶贤者正装。  
2. **气场**：抬头沉肩；**禁止摊手展示**；上手食指/掌压棋盘「正在走子」，下一手一抚核一扣袍侧。  
3. **对比**：躯干更深炭灰，脸/核/眼/盘更亮。  
4. **棋盘**：更大更贴背后主视觉；1–2 子近手被操控。  
5. 继承：四臂、石质、核、少苔藓、青绿符文。
