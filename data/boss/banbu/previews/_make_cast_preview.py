"""Generate 2x3 cast preview sheet + play-once GIF for Boss banbu cast.
...
FRAMES_DIR = r"D:/KAFA/Workspace/ohter/AdventureIsland_banbu/assets/sprites/boss/banbu/form1_giant_spore_turtle/cast"
PREVIEWS_DIR = r"D:/KAFA/Workspace/ohter/AdventureIsland_banbu/data/boss/banbu/previews"
OUT_TEMP = r"d:\KAFA\Workspace\ohter\AdventureIsland\_cast_preview_temp"
PYTHON = r"C:\Users\54196\AppData\Local\MI\ContinuityApp\runtimes\python-win\python.exe"

os.makedirs(OUT_TEMP, exist_ok=True)
SHEET_PATH = os.path.join(OUT_TEMP, "cast_sheet_preview.png")
GIF_PATH = os.path.join(OUT_TEMP, "cast_cycle.gif")
...
frames_rgba = []
for i in range(1, 7):
    p = os.path.join(FRAMES_DIR, f"banbu-cast-frame-{i}.png")
...
deploy(SHEET_PATH, "cast_sheet_preview.png")
deploy(GIF_PATH, "cast_cycle.gif")
print("--- done ---")
