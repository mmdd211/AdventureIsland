...
const HERO_ANIMATIONS := {
	...
	"run": {
		...
		"frames": [
			...
			"res://data/player/normalized/run-frame-5.png",
			"res://data/player/normalized/run-frame-6.png",
			"res://data/player/normalized/run-frame-7.png",
			"res://data/player/normalized/run-frame-8.png",
		],
	},
	"walk": {
		"fps": 12.0,
